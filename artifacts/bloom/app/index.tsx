    ...
    <View style={[styles.container, { backgroundColor: colors.primary }]}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.featureRow}>
          {[
            { label: "Lessons", path: "M12 2a10 10 0 1 0 0 20A10 10 0 0 0 12 2zm1 14.93V18h-2v-1.07A8 8 0 0 1 4.07 11H6v-2H4.07A8 8 0 0 1 11 3.07V5h2V3.07A8 8 0 0 1 19.93 9H18v2h1.93A8 8 0 0 1 13 16.93z" },
